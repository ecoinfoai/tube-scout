...
class TestReportPerformance:
    ...
    def test_channel_report_500_videos_under_5_min(self, tmp_path: Path) -> None:
        ...
        (data_dir / "processed" / "suggestions").mkdir(parents=True, exist_ok=True)

        generator = ChannelReportGenerator(data_dir=data_dir)
        output_dir = tmp_path / "reports"

        start = time.monotonic()
        result_path = generator.generate(channel_id=channel_id, output_dir=output_dir)
